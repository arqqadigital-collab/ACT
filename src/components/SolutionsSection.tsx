...
import itInfrastructureImg from "@/assets/solutions/it-infrastructure.jpg";
import networkImg from "@/assets/solutions/network.jpg";
import cyberSecurityImg from "@/assets/solutions/cyber-security.jpg";
import digitalAiImg from "@/assets/solutions/digital-ai.jpg";
...
const SolutionsSection = () => {
  ...
  return (
    <section ref={sectionRef} id="solutions" className="py-20 bg-background relative overflow-hidden">
        ...
        >
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">
              Building the Foundation for <span className="text-gradient">Digital Success</span>
            </h2>
          </div>
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                <div className="transform transition-transform duration-500 group-hover:translate-y-0 translate-y-4">
                  <span className="text-primary font-bold text-sm mb-2 block">{solution.subtitle}</span>
