  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      >
        ...
        >
          From a small, determined team to a regional ICT leader serving over
          3,000 customers with more than 500 experts sharing one mission: making
          technology an enabler of progress.
        </p>
      </div>
