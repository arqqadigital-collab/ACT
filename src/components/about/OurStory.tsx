        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                Our story began in 1988 with a simple belief that technology could transform Egypt's future. What
                started as a small, determined team has grown into a regional ICT leader, serving over 3,000 customers
                and powered by more than 500 experts who share one mission: to make technology an enabler of progress.
              </p>
              <p>
                For over three decades, we've been at the heart of Egypt's digital transformation building trust,
                driving innovation, and helping businesses and communities thrive in a connected world.
              </p>
              <p>
                Today, with offices in Egypt, Dubai, KSA, and Germany, and recognition from Oracle as a Global Partner
                Industry Solution, ACT continues to bridge local roots with global ambitions empowering organizations to
                grow, innovate, and lead into the future.
              </p>
            </div>
          </div>
